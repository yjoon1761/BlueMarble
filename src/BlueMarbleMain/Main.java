...
//                                }
                                ...
                                System.out.println("주사위 값은 " + diceValue + "입니다.");
...
//                                        }
                                    ...
                                    case 13:
                                        ...
                                        if (currentPlayerLocation == 13) {
                                            ...
                                            System.out.println("주사위를 한 번 더 던집니다.");
                                        ...
                                        // 이동한 후 위치 출력
                                        System.out.println("이동한 후 위치: " + sql.getLocationName(newLocation));

                                        // 현재 위치 업데이트
                                        sql.updatePlayerLocation(playerNum, newLocation);

                                        // 현재 위치 출력
                                        String currentLocation = sql.getLocationName(newLocation);
                                        System.out.println("도착한 후 현재 위치는 : " + currentLocation + " 입니다.");
                                        break;
                                    default:
                                        if (land != null) {
